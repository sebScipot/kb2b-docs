...
- **Author notes on documents.** You can now attach short notes to a document **before extraction** to guide how kb2b interprets it — for example, _"vendor X marketing material"_ or _"draft, not yet approved"_. Notes never become facts and never appear in chat: they only frame how the document is read. Up to 5 notes per document, 16 KB inline or 80 KB as a file. See [Author notes](/en/user/author-notes).
